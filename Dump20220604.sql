...
INSERT INTO `teste` VALUES (1,'Edilson');
...
-- Dump completed on 2022-06-04 14:37:22
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-04-29 19:07:04',NULL),('diagnostics.include_raw','OFF','2022-04-29 19:07:04',NULL),('ps_thread_trx_info.max_length','65535','2022-04-29 19:07:04',NULL),('statement_performance_analyzer.limit','100','2022-04-29 19:07:04',NULL),('statement_performance_analyzer.view',NULL,'2022-04-29 19:07:04',NULL),('statement_truncate_len','64','2022-04-29 19:07:04',NULL);
...
-- Dump completed on 2022-06-04 14:37:25
CREATE DATABASE  IF NOT EXISTS `corporatedb` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `corporatedb`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: localhost    Database: corporatedb
-- ------------------------------------------------------
-- Server version	8.0.29
...
INSERT INTO `usuario` VALUES (10,'0000','aminuddin');
...
-- Dump completed on 2022-06-04 14:37:25
CREATE DATABASE  IF NOT EXISTS `testedb` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `testedb`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
...
INSERT INTO `tabela_usuario` VALUES (1,'admin','admin'),(2,'teste','12345');
...
-- Dump completed on 2022-06-04 14:37:25
CREATE DATABASE  IF NOT EXISTS `db_sisterial` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_sisterial`;
-- MySQL dump 10.13  Distrib 8.0.29, for Win64 (x86_64)
--
-- Host: localhost    Database: db_sisterial
-- ------------------------------------------------------
-- Server version	8.0.29
...
CREATE TABLE `tbl_departamento` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) COLLATE utf8_bin NOT NULL,
  `representante` varchar(45) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_departamento` VALUES (1,'Recursos Humano','Antonio Cassiano'),(2,'Tecnologia de Informacao','Rohngo');
...
CREATE TABLE `tbl_entrada` (
  ...
  PRIMARY KEY (`id`),
  KEY `entrada_material_idx` (`id_material`),
  KEY `entrada_fornecedor_idx` (`id_fornecedor`),
  KEY `entrada_receptor_idx` (`id_receptor`),
  CONSTRAINT `entrada_fornecedor` FOREIGN KEY (`id_fornecedor`) REFERENCES `tbl_funcionario` (`id`),
  CONSTRAINT `entrada_material` FOREIGN KEY (`id_material`) REFERENCES `tbl_material` (`id`),
  CONSTRAINT `entrada_receptor` FOREIGN KEY (`id_receptor`) REFERENCES `tbl_funcionario` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_entrada` VALUES (1,'2022-05-23 19:10:15',1,1,1),(2,'2022-05-23 19:10:15',2,1,2);
...
CREATE TABLE `tbl_funcionario` (
  ...
  CONSTRAINT `id_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `tbl_departamento` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_funcionario` VALUES (1,'Wacate',2),(2,'Teresa Ana',1);
...
INSERT INTO `tbl_material` VALUES (1,'Lapis','HB',12),(2,'Caneta Preta','Filtro',5),(3,'Caneta Vermeha','BIC',10),(4,'Giz','Branco',100),(5,'Marcador','Preto',20),(6,'Marcador','Azul',12);
/*!40000 ALTER TABLE `tbl_material` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_nivelpermissao`
--

DROP TABLE IF EXISTS `tbl_nivelpermissao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_nivelpermissao` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nivel_permissao` varchar(15) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_nivelpermissao`
--

LOCK TABLES `tbl_nivelpermissao` WRITE;
/*!40000 ALTER TABLE `tbl_nivelpermissao` DISABLE KEYS */;
INSERT INTO `tbl_nivelpermissao` VALUES (1,'comum'),(2,'administrador'),(3,'convidado');
/*!40000 ALTER TABLE `tbl_nivelpermissao` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_pedido` (
  ...
  `id_pedidor` int NOT NULL,
  `id_estado` int DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `tipo de pedido_idx` (`tipo_pedido`),
  KEY `pedidor_idx` (`id_pedidor`),
  KEY `estado pedido_idx` (`id_estado`),
  CONSTRAINT `estado pedido` FOREIGN KEY (`id_estado`) REFERENCES `tbl_tipoestadopedido` (`id`),
  CONSTRAINT `pedidor` FOREIGN KEY (`id_pedidor`) REFERENCES `tbl_usuario` (`id`),
  CONSTRAINT `tipo de pedido` FOREIGN KEY (`tipo_pedido`) REFERENCES `tbl_tipopedido` (`id`)
...
INSERT INTO `tbl_pedido` VALUES (1,1,1,1),(2,1,1,1),(3,1,3,1),(4,1,1,1),(5,1,1,1),(6,1,3,1),(7,1,1,1),(8,1,1,1),(9,1,1,1),(10,1,2,1),(11,1,6,1);
...
CREATE TABLE `tbl_saida` (
  ...
  PRIMARY KEY (`id`),
  KEY `saida_materia_idx` (`id_material`),
  KEY `saida_fornecedor_idx` (`id_fornecedor`),
  KEY `saida_receptor_idx` (`id_receptor`),
  CONSTRAINT `saida_fornecedor` FOREIGN KEY (`id_fornecedor`) REFERENCES `tbl_funcionario` (`id`),
  CONSTRAINT `saida_materia` FOREIGN KEY (`id_material`) REFERENCES `tbl_material` (`id`),
  CONSTRAINT `saida_receptor` FOREIGN KEY (`id_receptor`) REFERENCES `tbl_funcionario` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_saida` VALUES (2,'2022-05-23 19:34:03',1,5,1,2,'Para gerenciamento de projeto SIDA');
/*!40000 ALTER TABLE `tbl_saida` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_tipoestadopedido`
--

DROP TABLE IF EXISTS `tbl_tipoestadopedido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_tipoestadopedido` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo_Estado` varchar(15) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_tipoestadopedido`
--

LOCK TABLES `tbl_tipoestadopedido` WRITE;
/*!40000 ALTER TABLE `tbl_tipoestadopedido` DISABLE KEYS */;
INSERT INTO `tbl_tipoestadopedido` VALUES (1,'Não Resolvido'),(2,'Resolvido'),(3,'Pendente');
/*!40000 ALTER TABLE `tbl_tipoestadopedido` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_tipopedido` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tipo_pedido` varchar(30) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_tipopedido` VALUES (1,'Reset de Senha'),(2,'Confirmacao de Material');
...
CREATE TABLE `tbl_usuario` (
  ...
  `senha` varchar(20) COLLATE utf8_bin DEFAULT '12345',
  `nivel_permissao` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `username_UNIQUE` (`username`),
  KEY `pemissao_idx` (`nivel_permissao`),
  CONSTRAINT `nivel_permissao` FOREIGN KEY (`nivel_permissao`) REFERENCES `tbl_nivelpermissao` (`id`)
...
INSERT INTO `tbl_usuario` VALUES (1,'admin','admin',2),(2,'horacio','0000',1),(3,'focas','0000',1),(4,'irene','2222',1),(5,'augusta','3333',1),(6,'teste','12',3),(8,'teste01','12345',1);
...
/*!50001 VIEW `new_view` AS select `tbl_usuario`.`id` AS `id`,`tbl_usuario`.`username` AS `username`,`tbl_usuario`.`senha` AS `senha`,`tbl_usuario`.`nivel_permissao` AS `nivel_permissao` from `tbl_usuario` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
